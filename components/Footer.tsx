  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Market Analysis', href: '/blog/analysis' },
      ],
    },
  ]

  const bestArticles = [
    { name: 'How to Start Trading Crypto', href: '/blog/start-trading' },
    { name: 'Understanding Leverage Trading', href: '/blog/leverage' },
    { name: 'Copy Trading Guide', href: '/blog/copy-trading' },
  ]
    ...
    <footer className="bg-[#0A0A0A] border-t border-[#1E1E1E]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <div className="flex space-x-4 mb-6">
              ...
              <a href="#" className="text-[#A0A0A0] hover:text-[#00D9FF] transition-colors" aria-label="YouTube">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              <a href="#" className="text-[#A0A0A0] hover:text-[#00D9FF] transition-colors" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="#" className="text-[#A0A0A0] hover:text-[#00D9FF] transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex gap-3">
              <a href="#" className="opacity-80 hover:opacity-100 transition-opacity">
                <div className="bg-white rounded-lg p-2 w-28 h-9 flex items-center justify-center">
        ...
        <div className="mt-12 pt-8 border-t border-[#1E1E1E]">
          <h3 className="text-white font-semibold mb-4">Our Best Articles</h3>
          <ul className="space-y-2">
        ...
        <div className="mt-12 pt-8 border-t border-[#1E1E1E]">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-[#A0A0A0]">
              © {new Date().getFullYear()} Margex. All rights reserved.
            </p>
          ...
          <p className="text-xs text-[#666] mt-4 text-center">
            Trading cryptocurrencies involves substantial risk of loss. Please trade responsibly.
          </p>
        </div>
      </div>
    </footer>
